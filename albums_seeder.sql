...
VALUES ('Michael Jackson', 'Thriller', 'Pop/Rock/R&B' 47.3),
('AC/DC','Back in Black', 'Hard rock',26.1),
('Pink Floyd' ,'The Dark Side of the Moon', 'Progressive rock', 24.2),
('Meat Loaf', 'Bat Out of Hell', 'Hard rock/Progressive rock', 21.5),
('Whitney Houston' ,'The Bodyguard', 'R&B/Soul/Pop/Soundtrack' ,28.4),
...
('Celine Dion','Lets Talk About Love','1996','Pop/Soft rock','19.3'),
...
('James Horner','Titanic: Music from the Motion Picture','199','Soundtrack,18.1'),
('Metallica','Metallica','1991','Thrash metal/Heavy metal','21.20'),
